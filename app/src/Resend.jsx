        ...
        <Page>
            <PageHeaderContents>
                <div className='w-full h-full flex items-center'>
                    <p className='text-lg font-bold ml-4'>Request New Verification Email</p>
                </div>
            </PageHeaderContents>
                ...
                <div className='w-full h-full flex flex-col justify-center items-center'>
                    <div className="flex flex-col">
                        ...
                        <div className="w-full flex flex-row justify-end">
                            <Button onClick={() => {sendVerificationEmail()}} color="primary" className='w-50 mt-2'>Send Verification Email</Button>
                        </div>
