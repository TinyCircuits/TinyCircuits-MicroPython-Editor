...
function FilesPanel(props){
    ...
    const getRow = (node) => {
        if(node.isLeaf){
            return(
                <div className={"w-full flex flex-row hover:bg-base-200 cursor-pointer items-center " + (node.isFocused ? "bg-base-200" : "")}>
            ...
            return(
                <div className={"w-full flex flex-row hover:bg-base-200 cursor-pointer items-center"}>
                    {
