...
function PageHeader(props){
    ...
    return(
        <div className="w-full h-14 bg-base-100 border-b-base-300 border-b-4 flex items-center">
            ...
            <Button color="primary" size='sm' className="ml-2" title="ctrl-shift-c">
            ...
            <Button color="accent" size='sm' className="ml-4" title="ctrl-shift-u">
            ...
            <Button color="accent" size='sm' className="ml-2" title="ctrl-shift-y">
            ...
            <p className="text-base-content opacity-50 ml-24">
                V09_11_2024_1
            </p>
        </div>
    )
